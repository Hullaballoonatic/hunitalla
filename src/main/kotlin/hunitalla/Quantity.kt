...
abstract class Quantity<Q : Quantity<Q>>(value: Double, name: String?, val unit: Unit<Q>, val dimension: Dimension) : Named, Valuable<Double> {
    ...
    override val value = value * unit.toSIConversionFactor
    ...
    operator fun times(other: Quantity<*>): Quantity<*> = (dimension * other.dimension).si(value * (other.value))

    operator fun div(other: Quantity<*>): Quantity<*> = (dimension / other.dimension).si(value / (other.value))
